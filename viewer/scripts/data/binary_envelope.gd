...
## Vendored from vr-start scripts/DataSources/binary_envelope.gd (tag 1.1.0); local changes noted below.
## (No local changes — copied unchanged apart from this header.)
